...
Partial Public Class DataSet1
    ...
    Partial Public Class pedidoDataTable
        ...
        Private columnnumeroDetalle As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public ReadOnly Property numeroDetalleColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnnumeroDetalle
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Overloads Function AddpedidoRow(ByVal idPedido As Integer, ByVal fecha As Date, ByVal estado As String, ByVal cantidad As Integer, ByVal precio As Integer, ByVal nombre As String, ByVal total As Integer, ByVal subtotal As Integer) As pedidoRow
            Dim rowpedidoRow As pedidoRow = CType(Me.NewRow, pedidoRow)
            Dim columnValuesArray() As Object = New Object() {idPedido, fecha, estado, Nothing, cantidad, precio, nombre, total, subtotal}
        ...
        Friend Sub InitVars()
            ...
            Me.columnnumeroDetalle = MyBase.Columns("numeroDetalle")
        ...
        Private Sub InitClass()
            ...
            Me.columnnumeroDetalle = New Global.System.Data.DataColumn("numeroDetalle", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnnumeroDetalle)
            ...
            Me.columnnumeroDetalle.AutoIncrement = True
            Me.columnnumeroDetalle.AutoIncrementSeed = -1
            Me.columnnumeroDetalle.AutoIncrementStep = -1
            Me.columnnumeroDetalle.AllowDBNull = False
            Me.columnnumeroDetalle.ReadOnly = True
    ...
    Partial Public Class pedidoRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Property numeroDetalle() As Integer
            Get
                Return CType(Me(Me.tablepedido.numeroDetalleColumn), Integer)
            End Get
            Set(value As Integer)
                Me(Me.tablepedido.numeroDetalleColumn) = value
            End Set
        End Property
        ...
        Public Property precio() As Integer
            Get
                Try
                    Return CType(Me(Me.tablepedido.precioColumn), Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property total() As Integer
            Get
                Try
                    Return CType(Me(Me.tablepedido.totalColumn), Integer)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property subtotal() As Integer
            Get
                Try
                    Return CType(Me(Me.tablepedido.subtotalColumn), Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("El valor de la columna 'subtotal' de la tabla 'pedido' es DBNull.", e)
                End Try
            End Get
            Set(value As Integer)
                Me(Me.tablepedido.subtotalColumn) = value
            End Set
        End Property
        ...
        Public Function IssubtotalNull() As Boolean
            Return Me.IsNull(Me.tablepedido.subtotalColumn)
        End Function

        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
        Public Sub SetsubtotalNull()
            Me(Me.tablepedido.subtotalColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DataSet1TableAdapters
    ...
    Partial Public Class pedidoTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("numeroDetalle", "numeroDetalle")
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        pedido.idPedido, pedido.fecha, pedido.estado, detallePedido.numeroD" & _
                "etalle, detallePedido.cantidad, detallePedido.precio, producto.nombre, pedido.to" & _
                "tal, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         detallePedido.subtotal" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            pedido I" & _
                "NNER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         detallePedido ON pedido.idPedido = detallePe" & _
                "dido.idPedido INNER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         producto ON detallePedido.idP" & _
                "roducto = producto.idProducto"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        pedido.idPedido, pedido.fecha, pedido.estado, detallePedido.numeroD" & _
                "etalle, detallePedido.cantidad, detallePedido.precio, producto.nombre, pedido.to" & _
                "tal, " & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         detallePedido.subtotal" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "FROM            pedido I" & _
                "NNER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         detallePedido ON pedido.idPedido = detallePe" & _
                "dido.idPedido INNER JOIN" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "                         producto ON detallePedido.idP" & _
                "roducto = producto.idProducto" & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & "WHERE        (pedido.estado = ?)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("estado", Global.System.Data.OleDb.OleDbType.WChar, 10, Global.System.Data.ParameterDirection.Input, CType(0, Byte), CType(0, Byte), "estado", Global.System.Data.DataRowVersion.Current, False, Nothing))
        End Sub
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DataSet1.pedidoDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DataSet1.pedidoDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
        ...
        Public Overridable Overloads Function FillBy(ByVal dataTable As DataSet1.pedidoDataTable, ByVal estado As String) As Integer
        ...
        Public Overridable Overloads Function GetDataBy(ByVal estado As String) As DataSet1.pedidoDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (estado Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            Else
